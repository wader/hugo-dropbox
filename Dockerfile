...
RUN \
  wget -O - "https://github.com/krallin/tini/releases/download/v0.10.0/tini" > /usr/local/bin/tini && \
  ...
  rm -rf tmp && \
  wget -O - "https://github.com/spf13/hugo/releases/download/v0.17/hugo_0.17_Linux-64bit.tar.gz" | tar xfz - && \
